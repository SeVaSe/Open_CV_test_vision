...
while True:
    ...
    faces = face_cascade.detectMultiScale(gray, 1.3, 3) # определяем лицо
    ...
    for (x, y, w, h) in faces:
        ...
        cv2.putText(frame, 'Face', (x-40, y-40), font, 2, (200,0,40), 2) # приписка, что это рот
        ...
        # вывод глаз
        eyes = eye_cascade.detectMultiScale(roy_grey, 1.8, 20) # определиение глаз
